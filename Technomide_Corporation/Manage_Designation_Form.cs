...
{
    public partial class Manage_Designation_Form : Form
    {
        public Manage_Designation_Form()
        {
            InitializeComponent();
        }
        ...
        private void Manage_Designation_Form_Load(object sender, EventArgs e)
        {
            Refresh();
        }
        ...
        public void Refresh()
        {
            dt = cls_employee.ShowAllDesignations();
            count = dt.Rows.Count;
        ...
        {
            cls_employee.ProcInsertDesignation(txt_designation_name.Text);
            Refresh();
        }
