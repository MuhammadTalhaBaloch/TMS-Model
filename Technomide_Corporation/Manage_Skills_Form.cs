...
{
    public partial class Manage_Skills_Form : Form
    {
        ...
        public Manage_Skills_Form()
        {
            InitializeComponent();
        }

        private void Manage_Skills_Form_Load(object sender, EventArgs e)
        {
            Refresh();
        }
        ...
        {
            cls_employee.ProcInsertSkills(txt_skill_name.Text);
            Refresh();
        }
    }
}
