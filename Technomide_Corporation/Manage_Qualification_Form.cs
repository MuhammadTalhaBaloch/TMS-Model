...
{
    public partial class Manage_Qualification_Form : Form
    {
        public Manage_Qualification_Form()
        {
            InitializeComponent();
        }
        ...
        private void Manage_Qualification_Form_Load(object sender, EventArgs e)
        {
            Refresh();
        }
        ...
        public void Refresh()
        {
            dt = cls_employee.ShowAllQualification();
            count = dt.Rows.Count;
        ...
        {
            cls_employee.ProcInsertQualification(txt_qualification_name.Text);
            Refresh();
        }
    }
}
